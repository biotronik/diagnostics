    ...
    return (
      <Fragment>
        ...
        <TwoColumnsTextImage
          ...
          featureC="Efficient, low-risk insertion -- BioMonitor is inserted just under the skin in a simple procedure that usually takes less than 10 minutes and can be performed under local anesthesia."
          benefitC="Routine procedure -- Little or no disruption to your daily life for insertion procedure."
